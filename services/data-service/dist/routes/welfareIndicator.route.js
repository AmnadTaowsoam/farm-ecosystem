...
wiRouter.get('/welfare-indicators', async (req, res, next) => {
    try {
...
wiRouter.get('/welfare-indicators/:id', async (req, res, next) => {
    try {
...
wiRouter.post('/welfare-indicators', async (req, res, next) => {
    try {
        const data = req.body;
...
wiRouter.put('/welfare-indicators/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const data = req.body;
...
wiRouter.delete('/welfare-indicators/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
