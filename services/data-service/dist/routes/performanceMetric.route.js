...
pmRouter.get('/performance-metrics', async (req, res, next) => {
    try {
...
pmRouter.get('/performance-metrics/:id/:date', async (req, res, next) => {
    try {
...
pmRouter.post('/performance-metrics', async (req, res, next) => {
    try {
        const data = req.body;
...
pmRouter.put('/performance-metrics/:id/:date', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const date = req.params.date;
        const data = req.body;
...
pmRouter.delete('/performance-metrics/:id/:date', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const date = req.params.date;
