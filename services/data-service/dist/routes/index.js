...
const deviceGroup_route_1 = __importDefault(require("./deviceGroup.route"));
const deviceType_route_1 = __importDefault(require("./deviceType.route"));
const device_route_1 = __importDefault(require("./device.route"));
const deviceLogs_route_1 = __importDefault(require("./deviceLogs.route"));
const deviceStatusHistory_route_1 = __importDefault(require("./deviceStatusHistory.route"));
...
const feedBatch_route_1 = __importDefault(require("./feedBatch.route"));
const feedBatchAssign_route_1 = __importDefault(require("./feedBatchAssign.route"));
...
const feedComposition_route_1 = __importDefault(require("./feedComposition.route"));
...
const economic_route_1 = __importDefault(require("./economic.route"));
const externalFactor_route_1 = __importDefault(require("./externalFactor.route"));
const sensor_route_1 = __importDefault(require("./sensor.route"));
...
router.use('/device-group', deviceGroup_route_1.default);
router.use('/device-types', deviceType_route_1.default);
router.use('/devices', device_route_1.default);
router.use('/devices-logs', deviceLogs_route_1.default);
router.use('/device-status-history', deviceStatusHistory_route_1.default);
router.use('/animals', animal_route_1.default);
router.use('/genetic-factors', geneticFactor_route_1.default);
router.use('/feed-batches', feedBatch_route_1.default);
router.use('/feed-batch-assignments', feedBatchAssign_route_1.default);
router.use('/feed-programs', feedProgram_route_1.default);
router.use('/feed-intake', feedIntake_route_1.default);
router.use('/feed-compositions', feedComposition_route_1.default);
...
router.use('/economic-data', economic_route_1.default);
router.use('/external-factors', externalFactor_route_1.default);
router.use('/sensor-data', sensor_route_1.default);
