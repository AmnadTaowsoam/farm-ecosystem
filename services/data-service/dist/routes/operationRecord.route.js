...
orRouter.get('/operational-records', async (req, res, next) => {
    try {
...
orRouter.get('/operational-records/:id', async (req, res, next) => {
    try {
...
orRouter.post('/operational-records', async (req, res, next) => {
    try {
        const data = req.body;
...
orRouter.put('/operational-records/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const data = req.body;
...
orRouter.delete('/operational-records/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
