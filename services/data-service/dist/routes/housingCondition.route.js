...
hcRouter.get('/housing-conditions', async (req, res, next) => {
    try {
...
hcRouter.get('/housing-conditions/:id', async (req, res, next) => {
    try {
...
hcRouter.post('/housing-conditions', async (req, res, next) => {
    try {
        const data = req.body;
...
hcRouter.put('/housing-conditions/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const data = req.body;
...
hcRouter.delete('/housing-conditions/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
