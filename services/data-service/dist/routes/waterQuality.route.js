...
wqRouter.get('/water-quality', async (req, res, next) => {
    try {
...
wqRouter.get('/water-quality/:id', async (req, res, next) => {
    try {
...
wqRouter.post('/water-quality', async (req, res, next) => {
    try {
        const data = req.body;
...
wqRouter.put('/water-quality/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const data = req.body;
...
wqRouter.delete('/water-quality/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
