...
hrRouter.get('/', async (req, res, next) => {
    try {
...
hrRouter.get('/:id', async (req, res, next) => {
    try {
...
hrRouter.post('/', async (req, res, next) => {
    try {
        const data = req.body;
...
hrRouter.put('/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
        const data = req.body;
...
hrRouter.delete('/:id', async (req, res, next) => {
    try {
        const id = Number(req.params.id);
